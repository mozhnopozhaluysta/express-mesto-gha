...
module.exports.getInitialCards = (req, res) => {
  ...
  // отправляется ответ с кодом статуса 200 (OK) и найденными
  // карточками в формате JSON.
    .then((cards) => res.status(200).send(cards))
    // обработка ошибки при выполнении запроса.
    // Если произошла ошибка при поиске карточек, отправляется ответ
    // с кодом статуса 500 (Internal Server Error) и объектом,
    // содержащим сообщение об ошибке в формате JSON.
